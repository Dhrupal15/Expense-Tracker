...
struct Properties {
    ...
    var fontTextInSlices:UIFont = UIFont(name: "Arial", size: 16)!
    //font to use in the center
    var fontTextCenter:UIFont = UIFont(name: "Arial", size: 14)!
...
class MDRotatingPieChart: UIControl {
    ...
    override init(frame: CGRect) {
        ...
        labelCenter.frame = CGRect(x: UIScreen.main.bounds.width/3.5, y: frame.origin.y + pieChartCenter.y, width: 100, height: 24)
        labelCenter.center = CGPoint(x: UIScreen.main.bounds.width/2, y: frame.origin.y + pieChartCenter.y)
        labelCenter.textColor = UIColor.white
        labelCenter.numberOfLines = 2
        labelCenter.textAlignment = .center
        labelCenter.text = "Expense Chart"
